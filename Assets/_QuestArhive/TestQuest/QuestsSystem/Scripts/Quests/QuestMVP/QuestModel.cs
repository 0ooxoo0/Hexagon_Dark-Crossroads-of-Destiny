...
public class QuestModel : MonoBehaviour
{
    ...
    public void QuestTarget(Transform pos)
    {
        targetEF = Instantiate(TargetEffect, pos);
        targetEF.transform.localPosition = Vector3.zero;
        targetEF.transform.position = new Vector3(targetEF.transform.position.x, 0, targetEF.transform.position.z);
    }    
