...
{
    [SerializeField] KartaController Karta;
    [SerializeField] QuestData DataNull;
    ...
    [SerializeField] private DropdownAnimator _listPanel;
    ...
    //public Image highlitedImg;
    [SerializeField] bool hasSelected;
    private bool highlighted;
    public QuestData highlitedData;
    ...
    public void select()
    {
        ...
        //if (highlitedData.quest_targetMarker != null)
        //Karta.MarkerInstatiate(highlitedData.quest_targetMarker);
        //else
        //{
        //Debug.Log("quest_targetMarker == Null || " + highlitedData.progress);
        //Debug.Log("quest_targetMarker == Null || " + highlitedData.quest_targetMarker);
        //}

        if (highlitedData == null)
        {
            Debug.LogError("highlitedData is null");
            return;
        }
    ...
    private GameObject CreateQuestCell(QuestData data)
    {
        ...
        cell_obj.GetComponent<QuestCell>().mask = mask;
        cell_obj.GetComponent<QuestCell>().SelectBtn = SelectBtn;
