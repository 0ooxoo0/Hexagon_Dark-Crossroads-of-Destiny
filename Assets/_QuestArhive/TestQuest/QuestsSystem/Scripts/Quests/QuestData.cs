...
public class QuestData 
{
    ...
    //[field: SerializeField] public Transform quest_targetMarker { get; private set; }
    ...
    public QuestData(int goal, string name, string desc,
        int reward, int id, /*Transform targetMarker,*/ int progress, 
        ...
        bool animation_start, bool animation_finish)
    {
        ...
        gold_reward = reward;
        quest_id = id;
        //quest_targetMarker = targetMarker;
        highlighted = false;
    }
